...
class HighlightPipeline:
    ...
    def _configure_pipeline_logging(self) -> None:
        """
        Attach a per-game log file handler for hockey_extractor.* loggers.
        ...
        try:
            ...
            pkg_logger = logging.getLogger("hockey_extractor")
    ...
    def _cleanup(self):
        ...
        try:
            if self._log_handler is not None:
                logging.getLogger("hockey_extractor").removeHandler(self._log_handler)
                try:
