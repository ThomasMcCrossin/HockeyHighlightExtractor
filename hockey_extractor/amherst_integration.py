...
Usage:
    from hockey_extractor.amherst_integration import AmherstBoxScoreProvider
...
def find_amherst_display_path() -> Optional[Path]:
    ...
    hockey_extractor_dir = this_file.parent
    project_dir = hockey_extractor_dir.parent.parent  # Up to parent of HockeyHighlightExtractor
